...
class ContactFormTest extends TestCase
{
    ...
    public function contact_form_sends_out_an_email()
    {
        ...
        Livewire::test(ContactForm::class)
            ->set('name', 'Bane')    
            ->set('email', 'bane@gmail.com')    
            ->set('phone', '0645633456')    
        ...
        Mail::assertSent(function(ContactFormMailable $mail){
            ...
            return $mail->hasTo('bane@hotmail.com') && 
                $mail->hasFrom('bane@gmail.com') &&
    ...
    /** @test */
    public function contact_form_message_field_has_min_characters()
    {
        Livewire::test(ContactForm::class)
            ->set('message', 'This')
            ->call('submitForm')
